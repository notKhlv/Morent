...
import View2 from "../assets/ken1.jpg";
import View3 from "../assets/ken2.jpg";
import View4 from "../assets/ken3.jpg";
  ...
  return (
    ...
    <div className="bg-[#F5f6f7] w-full flex">
      ...
      <div className="">
        <div className="bg-gradient-to-r  from-sky-500 to-indigo-500 w-[450px] mt-10 ml-16 h-[340px] rounded-xl px-6 py-6">
          ...
          <img
            src={Kenig}
            alt=""
            className="ml-16 scale-150 mt-4  hover:scale-125 ease-linear duration-300"
          />
        </div>
      ...
      <div className="bg-[#fff] rounded-xl ml-[-500px] mt-10 h-[480px] px-7 py-5 w-[500px] relative top-0">
        <div className="flex justify-between">
          <h2 className="font-[500] text-[29px]">Koenigsegg</h2>
        ...
        <div className="flex w-[200px] gap-1 mt-1">
          ...
          <IoIosStarOutline className="text-[#596780]" />
          <IoIosStarOutline className="text-[#596780]" />
          <p className="text-[#596780] text-xs">320+ Reviewer</p>
        </div>
        <p className="text-[#596780] font-[300] text-[18px] w-[340px] mt-10">
          Koenig has become the embodiment of Koenigsegg's outstanding performance,
        ...
        <div className="flex gap-16 mt-4">
          ...
          <p className="text-[17px] text-[#596780] ml-10">90L</p>
        </div>
        <div className="flex ">
          <p className="text-2xl font-semibold mt-14">$89.00/</p>
